export function MoreDetails({ label, value, highlight, old_balance, status }: { label: string; value: string | number; highlight?: boolean; old_balance?: boolean; status?: string; }) {
